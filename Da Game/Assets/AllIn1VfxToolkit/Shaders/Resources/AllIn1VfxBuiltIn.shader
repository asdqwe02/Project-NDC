    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 frag(v2f i) : SV_Target
            {
                ...
                half seed = i.uvSeed.z + UNITY_ACCESS_INSTANCED_PROP(Seeds, _TimingSeed);
                half time = _Time.y + seed;
				...
				half2 shape1Uv = i.uvSeed.xy;
            	#if SHAPE2_ON
            	half2 shape2Uv = shape1Uv;
            	#endif
            	#if SHAPE3_ON
            	half2 shape3Uv = shape1Uv;
            	#endif
