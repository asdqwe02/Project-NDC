half4 SampleTextureWithScroll(sampler2D tex, half2 uv, half scrollXSpeed, half scrollYSpeed, half time)
{
...
half2 RotateUvs(half2 uv, half rotation, half4 scaleAndTranslate)
{
